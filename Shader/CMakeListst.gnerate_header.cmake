...
create_directory(${AETHER_GENERATED_DEPEND_DIR})
create_directory(${AETHER_GENERATED_META_DIR})
create_directory(${AETHER_GENERATED_TAG_DIR}/${SHADER_COMPILE_FILE_SUFFIX})
create_directory(${AETHER_GENERATED_TAG_DIR}/${SHADER_DEPEND_FILE_SUFFIX})

create_directory(${AETHER_GENERATED_SHADER_DIR}/spirv)
create_directory(${AETHER_GENERATED_SHADER_DIR}/dxil)


# create directory
foreach(TARGET_PLATFORM ${shader_target_platform})
    create_directory(${AETHER_GENERATED_SHADER_DIR}/${TARGET_PLATFORM})
    if (AETHER_SHADER_GENERATE_DEBUG)
        create_directory(${AETHER_GENERATED_SHADER_DIR}/${TARGET_PLATFORM}${SHADER_DEBUG_DIR_SUFFIX})
    endif()
endforeach()
...
set(GENERATED_SHADER_CONTENT_PART1 "#include \"${AETHER_GENERATED_META_DIR}/${GENERATED_SHADER_META_CONTENT_FILE}\"\n")
...
foreach(TARGET_PLATFORM ${shader_target_platform})
    string(APPEND GENERATED_SHADER_CONTENT_PART1 "#include \"${AETHER_GENERATED_SHADER_DIR}/${TARGET_PLATFORM}/${GENERATED_SHADER_CODE_CONTENT_FILE}\"\n")
    string(APPEND GENERATED_SHADER_CONTENT_PART2 "FUNC_QueryShaderCodeContent(${TARGET_PLATFORM},)\n")
    string(APPEND GENERATED_SHADER_CONTENT_PART1 "#include \"${AETHER_GENERATED_SHADER_DIR}/${TARGET_PLATFORM}/${GENERATED_SHADER_REFLECT_CONTENT_FILE}\"\n")
    ...
    if (AETHER_SHADER_GENERATE_DEBUG)
        string(APPEND GENERATED_SHADER_CONTENT_PART1 "#include \"${AETHER_GENERATED_SHADER_DIR}/${TARGET_PLATFORM}${SHADER_DEBUG_DIR_SUFFIX}/${GENERATED_SHADER_CODE_CONTENT_FILE}\"\n")
        string(APPEND GENERATED_SHADER_CONTENT_PART2 "FUNC_QueryShaderCodeContent(${TARGET_PLATFORM},${SHADER_DEBUG_DIR_SUFFIX})\n")
        string(APPEND GENERATED_SHADER_CONTENT_PART1 "#include \"${AETHER_GENERATED_SHADER_DIR}/${TARGET_PLATFORM}${SHADER_DEBUG_DIR_SUFFIX}/${GENERATED_SHADER_REFLECT_CONTENT_FILE}\"\n")
...
file(WRITE ${AETHER_GENERATED_SHADER_DIR}/${GENERATED_SHADER_CONTENT_FILE}
    "#pragma once\n"
...
file(WRITE ${AETHER_GENERATED_META_DIR}/${GENERATED_SHADER_META_CONTENT_FILE}
    "#pragma once\n"
    "#include \"shader_content_def.h\"\n"
...
foreach(TARGET_PLATFORM ${shader_target_platform})
    ...
    file(WRITE ${AETHER_GENERATED_SHADER_DIR}/${TARGET_PLATFORM}/${GENERATED_SHADER_CODE_CONTENT_FILE}
        "#pragma once\n"
        "#include \"shader_content_def.h\"\n"
    ...
    if (AETHER_SHADER_GENERATE_DEBUG)
        ...
        endforeach()
        string(APPEND GENERATED_SHADER_CODE_CONTENT_PART2 "}\;\n")
        file(WRITE ${AETHER_GENERATED_SHADER_DIR}/${TARGET_PLATFORM}${SHADER_DEBUG_DIR_SUFFIX}/${GENERATED_SHADER_CODE_CONTENT_FILE}
            "#pragma once\n"
            "#include \"shader_content_def.h\"\n"
            ${GENERATED_SHADER_CODE_CONTENT_PART1}
            "\n"
...
foreach(TARGET_PLATFORM ${shader_target_platform})
    ...
    file(WRITE ${AETHER_GENERATED_SHADER_DIR}/${TARGET_PLATFORM}/${GENERATED_SHADER_REFLECT_CONTENT_FILE}
        "#pragma once\n"
        "#include \"shader_content_def.h\"\n"
    ...
    if (AETHER_SHADER_GENERATE_DEBUG)
        ...
        endforeach()
        string(APPEND GENERATED_SHADER_REFLECT_CONTENT_PART2 "}\;\n")
        file(WRITE ${AETHER_GENERATED_SHADER_DIR}/${TARGET_PLATFORM}${SHADER_DEBUG_DIR_SUFFIX}/${GENERATED_SHADER_REFLECT_CONTENT_FILE}
            "#pragma once\n"
            "#include \"shader_content_def.h\"\n"
            ${GENERATED_SHADER_REFLECT_CONTENT_PART1}
            "\n"
