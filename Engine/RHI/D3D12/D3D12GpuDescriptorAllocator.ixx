export module Aether:D3D12GpuDescriptorAllocator;
import :Engine;
...
export namespace Aether
{
	...
	*******************************************************************************/
	...
	{
	public:
		D3D12GpuDescriptorPage(AetherEngine* engine, int32_t size, D3D12_DESCRIPTOR_HEAP_TYPE type, D3D12_DESCRIPTOR_HEAP_FLAGS flags);
	...
	*******************************************************************************/
	...
	{
	public:
		D3D12GpuDescriptorAllocator(AetherEngine* engine, D3D12_DESCRIPTOR_HEAP_TYPE type, D3D12_DESCRIPTOR_HEAP_FLAGS flags);
