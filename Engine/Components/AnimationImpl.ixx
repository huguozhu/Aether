export module Aether:AnimationImp;
...
export namespace Aether
{
    ...
    public:
        ...
        virtual AResult                 Run(float time) override;
        AResult                         Run(float time, JointFusionMode jointFusionMode);

        TransformKeyFramePtr            CreateTransformKeyFrame();

    protected:
        virtual AResult                 GetInterpolatedKeyFrame(float time, KeyFrame& kf) override;
        AResult                         GetInterpolatedKeyFrame(float time, KeyFrame& kf, JointFusionMode jointFusionMode);
    };
    ...
    public:
        ...
        virtual AResult                     Run(float time) override;
        AResult                             Run(float time, MorphTargetWeightFusionMode weightFusionMode);
