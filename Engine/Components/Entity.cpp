...
export namespace Aether
{
    Entity::Entity(AetherEngine* engine, std::string name)
        :m_pEngine(engine), m_szName(name)
    {
    ...
    AResult Entity::Tick(float delta_time)
    {
    ...
    AResult Entity::AddToTopScene()
    {
        return AddToParent(m_pEngine->SceneManagerInstance().GetRootComponent().get());
    }

    AResult Entity::DeleteFromTopScene()
    {
        m_pEngine->SceneManagerInstance().GetRootComponent()->DelChild(m_pRootComponent);
        return A_Success;
    }

    AResult Entity::AddToParent(Entity* parent_entity)
    {
    ...
    AResult Entity::AddToParent(SceneComponent* parent_component)
    {
