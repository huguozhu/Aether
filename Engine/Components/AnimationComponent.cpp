export module Aether:AnimationComponent;
...
namespace Aether
{
    AnimationComponent::AnimationComponent(AetherEngine* engine)
        :Component(engine, "AnimationComponent", ComponentType::Animation)
    {
    }

    AResult AnimationComponent::SectionTick(float delta_time, uint32_t sectionIdx)
    {
    ...
    AResult AnimationComponent::Tick(float delta_time)
    {
    ...
    AResult AnimationTrack::GetKeyFrameIdxByTime(float& time, uint32_t& kfIdx)
    {
