...
{
    constexpr const float MIN_APERTURE = 0.5f;
    constexpr const float MAX_APERTURE = 64.0f;
    constexpr const float MIN_SHUTTER_SPEED = 1.0f / 25000.0f;
    constexpr const float MAX_SHUTTER_SPEED = 60.0f;
    constexpr const float MIN_SENSITIVITY = 10.0f;
    constexpr const float MAX_SENSITIVITY = 204800.0f;
    constexpr const uint32_t NUM_CSM_LEVELS = 4;
    ...
    {
    public:
        CameraComponent(AetherEngine* engine, CameraProjectionType type = CameraProjectionType::Perspective, std::string const& name = "CameraComponet");
    ...
    {
    public:
        LightCameraComponent(AetherEngine* engine, CameraProjectionType type = CameraProjectionType::Perspective, std::string const& name = "CameraComponet");
    ...
    {
    public:
        CsmCameraComponent(AetherEngine* engine, std::string const& name = "CSMCameraComponent");
