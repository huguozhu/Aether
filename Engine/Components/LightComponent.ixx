export module Aether:LightComponent;
...
export namespace Aether
{
    ...
    public:
        ...
        static LightComponentPtr CreateLightComponent(AetherEngine* engine, LightType lightType, std::string const& name = "LightComponent");
    ...
    protected:
        LightComponent(AetherEngine* engine, LightType lightType, std::string const& name = "LightComponent");
    ...
    {
    public:
        AmbientLightComponent(AetherEngine* engine, std::string const& name = "AmbientLightComponent");
    ...
    {
    public:
        DirectionalLightComponent(AetherEngine* engine, std::string const& name = "DirectionalLightComponent");
    ...
    {
    public:
        SpotLightComponent(AetherEngine* engine, std::string const& name = "SpotLightComponent");
    ...
    {
    public:
        PointLightComponent(AetherEngine* engine, std::string const& name = "PointLightComponent");
