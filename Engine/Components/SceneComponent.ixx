export module Aether:SceneComponent;
...
export namespace Aether
{
    ...
    {
    public:
        SceneComponent(AetherEngine* engine, std::string const& name = "SceneComponet", ComponentType type = ComponentType::Scene)
            : Component(engine, name, type)
        {
        }
