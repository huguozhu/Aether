...
namespace Aether
{
    CameraComponent::CameraComponent(AetherEngine* engine, CameraProjectionType type, std::string const& name)
        : SceneComponent(engine, name, ComponentType::Camera)
     ...
     ******************************************************************************/
    LightCameraComponent::LightCameraComponent(AetherEngine* engine, CameraProjectionType type, std::string const& name)
        :CameraComponent(engine, type, name)
    {
     ...
     * CSMCameraComponent
     ******************************************************************************/
    CsmCameraComponent::CsmCameraComponent(AetherEngine* engine, std::string const& name)
        : SceneComponent(engine, name, ComponentType::CsmCamera)
    {
        for (uint32_t i = 0; i < NUM_CSM_LEVELS; ++i)
        {
            m_pCSMCameras[i] = MakeSharedPtr<LightCameraComponent>(engine);
